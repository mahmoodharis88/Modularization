package com.sample.mutimodulesample.core.designsystem.component
...
fun SampleOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = SampleButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = SampleButtonDefaults.DISABLED_OUTLINED_BUTTON_BORDER_ALPHA,
                )
            },
        ),
        contentPadding = contentPadding,
...
fun SampleButtonPreview() {
    MutiModuleSampleTheme {
        SampleBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            SampleButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun SampleOutlinedButtonPreview() {
    MutiModuleSampleTheme {
        SampleBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            SampleOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun SampleButtonLeadingIconPreview() {
    MutiModuleSampleTheme {
        SampleBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            SampleButton(
                onClick = {},
